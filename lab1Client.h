#ifndef _LAB1_CLIENT_H_
#define _LAB1_CLIENT_H_
 ...
 *********************************/
bool getCommand(MyPacket& outgoingPkt, TicTacToe& game, const char& myMark) {
  ...
  if (strcmp(command, "EXIT\0") == 0) {
    ...
    // to leave this game.
    memset(outgoingPkt.buffer, 0, kBufferLen);
